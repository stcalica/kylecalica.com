                ...
                <div className="row justify-between gap-y-10">
                    ...
                    <div className="col-lg-3 col-md-6">
                        ...
                        <ul>
                            <li className="flex gap-x-[15px] mb-[10px]">
                                <img width={17} height={25} src="/assets/icons/phone.svg" alt="phone icon" />
                            ...
                            <li className="flex gap-x-[15px]">
                                <img width={17} height={25} src="/assets/icons/mail.svg" alt="mail icon" />
                    ...
                    <div className="col-lg-auto col-md-6">
                        ...
                        <ul className="flex items-center gap-x-[25px]">
                            <li><a href="#" className="hover:opacity-50 transition-all"><img width={17} height={29} src="/assets/icons/facebook.svg" alt="facebook icon" /></a></li>
