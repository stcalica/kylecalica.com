                ...
                <div className="row justify-between gap-y-20">
                    ...
                    <div className="col-auto">
                        <div className="flex items-start mb-[90px]">
                            <img className="mr-[25px] mt-[5px]" width={35} height={35} src="/assets/icons/phone.svg" alt="phone icon" />
                            <div>
                        ...
                        <div className="flex items-start mb-[90px]">
                            <img className="mr-[25px] mt-[5px]" width={35} height={35} src="/assets/icons/mail.svg" alt="Mail icon" />
                            <div>
                        ...
                        <div className="flex items-start">
                            <img className="mr-[25px] mt-[5px]" width={35} height={35} src="/assets/icons/thumbs_up.svg" alt="thumbs up icon" />
                            <div>
                                <h3 className="heading-4 text-white font-semibold mb-[10px]">Follow us on</h3>
                                <ul className="flex items-center gap-x-[25px]">
                                    <li><a href="#" className="hover:opacity-50 transition-all"><img width={17} height={17} src="/assets/icons/facebook.svg" alt="facebook icon" /></a></li>
                                    <li><a href={process.env.NEXT_PUBLIC_TWITTER_ID || "#" || "#"} target="_blank" className="hover:opacity-50 transition-all"><img width={24} height={24} src="/assets/icons/twitter.svg" alt="twitter icon" /></a></li>
                                    <li><a href={process.env.NEXT_PUBLIC_INSTA_ID || "#" || "#"} target="_blank" className="hover:opacity-50 transition-all"><img width={24} height={24} src="/assets/icons/instagram.svg" alt="instagram icon" /></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
